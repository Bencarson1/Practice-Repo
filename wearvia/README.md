...
The first shop on NebedaHub is **Nebeda Threads** (Gillingham, Kent) — designer number one. New tailors join with *I'm a tailor or designer* and appear once the admin approves them. NebedaHub works worldwide: every tailor and fabric seller has their own currency (see [Worldwide](#worldwide-currencies-yards-or-metres-phones-and-dates)); everything from before is in **£ (GBP)**.
