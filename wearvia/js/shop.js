    ...
    <div class="two-col">
      <div class="card">
        ...
        <form class="inline-form" onsubmit="return addRtwItem(event)">
          ...
          <input name="price" type="number" min="1" step="0.01" placeholder="Price £" required aria-label="Price" class="narrow">
          <input name="cost" type="number" min="0" step="0.01" placeholder="Cost £" required aria-label="Cost" class="narrow">
